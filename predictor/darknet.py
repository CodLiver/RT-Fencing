...
from predictor.cfg import *
import numpy as np
from predictor.region_layer import RegionLayer
from predictor.yolo_layer import YoloLayer
...
class Darknet(nn.Module):
    "ok this function should be converted into proper pytorch without using ifs and cfgfiles"
    def net_name(self):
